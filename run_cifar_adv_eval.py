...
FGM_SETTINGS = {
    np.inf: [0.0,  1e-2, 0.1, 1.0, 10.0, 25.0, 50.0],
    1: [3.0, 5.0, 7.0, 10.0, 30.0, 70.0, 100.0, 300.0, 500.0, 1000.0, 2000.0],
    2: [0.05, 0.1, 0.3, 0.5, 0.7, 1.0, 5.0, 10.0, 50.0, 100.0, 500.0, 1000.0]
}
